<div class="bg-white pb-20 pt-24 sm:pt-32">
  <div id="features" class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:text-center">
      ...
      <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Todo lo que este proyecto puede ofrecer</p>
